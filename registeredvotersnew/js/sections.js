...
var scrollVis = function () {
  ...
  var barColors = { 1: '#D61D2F', 2: '#D3373A', 3: '#FB5F5D' , 0: '#880006'};
 ...
 /* var xAxisHist = d3.axisBottom()
  ...
  function highlightGrid() {
    ...
    g.selectAll('.fill-square')
      ...
      .duration(800)
      .attr('opacity', 1.0)
      .attr('fill', function (d) { return d.filler1 ? '#FB5F5D' : '#ddd'; });
  }
  ...
  function updateCough(progress) {
    ...
    g.selectAll('.hist')
      ...
      .duration(0)
      .style('fill', function (d) {
        return (d.x0 >= 14) ? coughColorScale(progress) : '#fb5f5d';
      });
  }
